---
{"dg-publish":true,"permalink":"/Books/三角范畴与导出范畴/Ⅳ. 复形的分解/4.5 任意复形的同伦投射分解/","dgPassFrontmatter":true,"created":"2024-08-05T11:39:24.972+08:00","updated":"2024-09-12T13:01:37.391+08:00"}
---
...
若Grothendieck范畴 $\mathcal{A}$ 中有足够多的投射对象, 则 $\mathcal{A}$ 上任意复形都有同伦投射分解: $\operatorname{Cone}(1-p)\rightarrow \operatorname{Cone}(1-m)=\operatorname{Coker}(1-m)=X$. 又因为这个拟同构(可以加工成)是满射, 所以这个分解也是投射分解. <font color=CadetBlue>(怎么加工成满射呢, 就是不停地直和进形如 $\cdots\rightarrow P\stackrel{\operatorname{Id}_P}{\longrightarrow}P\rightarrow\cdots$ 的复形, 直到成为满射)</font>
