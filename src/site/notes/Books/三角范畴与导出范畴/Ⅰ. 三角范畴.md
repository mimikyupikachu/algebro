---
{"dg-publish":true,"permalink":"/Books/三角范畴与导出范畴/Ⅰ. 三角范畴/","dgPassFrontmatter":true,"created":"2024-06-27T12:22:48.927+08:00","updated":"2024-07-10T08:19:11.375+08:00"}
---
...
$4\times4$ **引理**: 设 $(\mathcal{C},[1])$ 是三角范畴, 对 $\mathcal{C}$ 中任意交换图<br/> <div style="text-align: center;">
$\begin{CD}A_{1}@>x_{1}>>B_{1}\\@Va_{1}VV@VVb_{1}V\\A_{2}@>>x_{2}>B_{2}\end{CD}$
</div>
以及 $\mathcal{C}$ 中给定的四个好三角<br/> <div style="text-align: center;">
...
存在下列态射图<br/> <div style="text-align: center;">
$\begin{CD}A_1@>x_1>>B_1@>y_1>>C_1@>z_1>>A_1[1]\\@VVa_1V@VVb_1V@VVc_1V@VVa_1[1]V\\A_2@>x_2>>B_2@>y_2>>C_2@>z_2>>A_2[1]\\@VVa_2V@VVb_2V@VVc_2V@VVa_2[1]V\\A_3@>x_3>>B_3@>y_3>>C_3@>z_3>>A_3[1]\\@VVa_3V@VVb_3V@VVc_3V@VV-a_3[1]V\\A_1[1]@>x_1[1]>>B_1[1]@>y_1[1]>>C_1[1]@>-z_1[1]>>A_1[2]\end{CD}$
</div>
