---
{"dg-publish":true,"permalink":"/Books/三角范畴与导出范畴/Ⅰ. 三角范畴/","dgPassFrontmatter":true,"created":"2024-06-27T12:22:48.927+08:00","updated":"2024-07-08T22:04:32.503+08:00"}
---
...
$\qquad$ ④**基变换Ⅱ**: 对于 $\mathcal{C}$ 中好三角 $A\stackrel{f}{\longrightarrow}B\stackrel{g}{\longrightarrow}C\stackrel{h}{\longrightarrow}A[1]$ 、 $\mathcal{C}$ 中态射 $\varepsilon:C'\rightarrow C$ 以及 $\mathcal{C}$ 中给定的两个好三角,存在如下交换图:<br/> <div style="text-align: center;"> $\begin{CD}@.E@=E\\@.@V\alpha VV @V\delta VV\\A@>f'>>B'@>g'>>C'@>h'>>A[1]\\@| @V\beta VV@V\varepsilon VV@|\\A@>f>>B@>g>>C@>h>>A[1]\\@.@V\gamma VV@V\eta VV@Vf'[1]VV\\@.E[1]@=E[1]@>-\alpha[1]>>B'[1]\end{CD}$</div>其中中建两行和中间两列均是好三角.