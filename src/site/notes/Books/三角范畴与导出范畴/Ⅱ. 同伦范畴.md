---
{"dg-publish":true,"permalink":"/Books/三角范畴与导出范畴/Ⅱ. 同伦范畴/","dgPassFrontmatter":true,"created":"2024-07-10T08:14:17.924+08:00","updated":"2024-07-19T22:27:26.950+08:00"}
---
...
**同伦不变量**: 链可裂短正合列 $X\stackrel{u}{\longrightarrow}Y\stackrel{v}{\longrightarrow}Z$ 的同伦不变量是指链映射 $h:Z\rightarrow X[1]$. $h$ 满足 ①  $u^{n+1}h^n=v'^{n+1}d^n_Z-d^n_Yv'^n;$ ② $h^nv^n=d^n_Xu'^n-u'^{n+1}d_Y^n$. 同伦不变量一定存在且同伦等价意义下唯一<font color=CadetBlue>(因为是 $v^n$ 的核)</font>.
