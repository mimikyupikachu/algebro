---
{"dg-publish":true,"permalink":"/Books/结合代数表示论基础/Ⅲ. Representations and modules/","dgPassFrontmatter":true,"created":"2024-07-05T15:07:47.047+08:00","updated":"2024-07-07T19:54:50.002+08:00"}
---
...
+ rep($Q$): Rep($Q$) 的[[Books/范畴论中若干基本概念和结论/1 范畴#^fullsubcat\|满子范畴]]. 对象是所有有限维表示. 是阿贝尔 [[Books/同调代数#^kcat\|K- 范畴]].
+ Rep($Q,\mathcal{I}$): $Q$ 的所有被 $\mathcal{I}$ 约束的 $K$- 线性表示范畴. 
+ rep($Q,\mathcal{I}$): Rep($Q,\mathcal{I}$) 的[[Books/范畴论中若干基本概念和结论/1 范畴#^fullsubcat\|满子范畴]]. 对象是所有有限维表示. 
