---
{"dg-publish":true,"permalink":"/Books/结合代数表示论基础/Ⅲ. Representations and modules/","dgPassFrontmatter":true,"created":"2024-07-05T15:07:47.047+08:00","updated":"2024-07-05T15:08:54.358+08:00"}
---
...
其中 $e_{1},e_{2},\cdots,e_{n}$ 是 $A$ 的本原正交幂等元, 和 $Q_0$ 中的点 $1,2,\cdots,n$ 一一对应. <font color=CadetBlue>(注意与[[Books/结合代数表示论基础/结合代数表示论基础#^ed453a\|模的维数]]$\mathrm{dim}_KM$做区分)</font>
