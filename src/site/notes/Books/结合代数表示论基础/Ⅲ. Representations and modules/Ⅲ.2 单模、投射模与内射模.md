---
{"dg-publish":true,"permalink":"/Books/结合代数表示论基础/Ⅲ. Representations and modules/Ⅲ.2 单模、投射模与内射模/","dgPassFrontmatter":true,"created":"2024-08-05T17:24:30.295+08:00","updated":"2024-10-08T10:53:10.732+08:00"}
---
...
$$\begin{split}
 ...
 $P(a)=e_{a}A=(P(a)_b,\varphi_\beta)$:	
 $$\begin{split}
 ...
 $\operatorname{rad}P(a)=(P'(a)_b,\varphi'_\beta)$:
  $$\begin{split}
	P'(a)_b \quad &= \quad P(a)_b若a\neq b\\ P'(a)_a \quad &= \quad 所有从\ a\ 到\ a\ 的非平稳路\ w\ 的剩余类\\&\qquad\ \   \bar{w}=w+\mathcal{I}\ 生成的线性空间\\
	\varphi_\beta\quad &=\quad 右乘\ \bar{\beta}=\beta+\mathcal{I}\qquad\varphi_{\beta}w=w\beta
	\end{split}$$

 $I(a)=D(Ae_a)=(I(a)_b,\varphi_\beta)$:      
 $$\begin{split} 
 ...
 $I(a)/S(a)=(L_b,\psi_\beta)$:      
 $$\begin{split} 
	 L_{b}\quad &=\quad I(a)_{b}的商空间,路的长度至少为一\\
	\psi_\beta\quad &=\quad 相应的
	\end{split}$$
