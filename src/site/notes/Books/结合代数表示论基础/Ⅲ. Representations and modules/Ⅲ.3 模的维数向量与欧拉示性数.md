---
{"dg-publish":true,"permalink":"/Books/结合代数表示论基础/Ⅲ. Representations and modules/Ⅲ.3 模的维数向量与欧拉示性数/","dgPassFrontmatter":true,"created":"2024-08-05T17:24:32.319+08:00","updated":"2024-08-07T13:22:06.184+08:00"}
---
...
**欧拉示性数(Euler characteristic)**: 设 $A$ 是基本 $K$- 代数, [[0rigin/有限维代数#^b7826e\|整体维数]]有限. 代数 $A$ 的欧拉示性数是 $\mathbb{Z}$- 非对称双线性型 $\left< -,- \right>_{A}:\mathbb{Z}^{n}\times \mathbb{Z}^{n}\rightarrow\mathbb{Z}.\quad\left< \mathbf{x},\mathbf{y} \right>_{A}=\mathbf{x}^{t}(\mathbf{C}_{A}^{-1})^{t}\mathbf{y}$
