---
{"dg-publish":true,"permalink":"/Books/结合代数表示论基础/Ⅱ. Quivers and algebras/","dgPassFrontmatter":true,"created":"2024-07-05T15:06:25.949+08:00","updated":"2024-07-05T15:34:49.943+08:00"}
---
...
设 $A$ 是有单位元的结合代数, $\{ e_{1}.e_{2},\cdots,e_{n} \}$ 是本原正交幂等元的完全集. 则 $A$ 是一个[[Books/结合代数表示论基础/Ⅰ. Algebras and modules#^a7012d\|连通代数]]当且仅当不存在一个 $\{ 1,2,\cdots,n \}$ 的非平凡划分 $I\dot{\cup} J$, 使得对 $i \in I$ 和 $j \in J$ 能推出 $e_{i}Ae_{j}=0=e_{j}Ae_{i}$. 
{ #9baff0}
...
$\qquad$ 若 $Q$ 是无圈的, 则 $\mathrm{rad}KQ=R$, 因此 $KQ$ 是有限维[[Books/结合代数表示论基础/Ⅰ. Algebras and modules#^54235c\|基本代数]].
